...
public:
  ...
  uint16_t  GHR;  // Global History Register to be updated 
                    // in accordance with the resolveDir
                    // and not predDir

  uint8_t PHT[4096]; // Pattern History Table, each entry contain 2-bit value
